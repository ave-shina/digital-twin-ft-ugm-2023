  ...
  return (
    <div className={clsx('flex w-full  flex-row items-center justify-between p-6')}>
      <div className={clsx(' left-6 top-6 flex  flex-row items-center justify-center')}>
        ...
        <h1 className={clsx(' text-xl font-bold text-black')}>FT UGM</h1>
      </div>
      <button
        onClick={() => {
          setContent('')
        ...
        className={clsx(
          'group absolute right-6 top-6 !z-30 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-solid border-black bg-transparent text-black sm:h-14 sm:w-14 ',
        )}>
